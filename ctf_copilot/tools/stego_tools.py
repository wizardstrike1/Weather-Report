"""Stego tooling is data-driven via :mod:`ctf_copilot.tools.registry` (category
`stego`). This module is the place for richer Python-native wrappers.
